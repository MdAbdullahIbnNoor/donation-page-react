        ...
        <div className="hero min-h-[700px] rounded-2xl bg-cover" style={{ backgroundImage: 'url("./images/banner.png")'}}>
            ...
            <div className="text-center text-neutral-content w-full ">
                ...
                <div className="flex justify-center items-center relative w-4/12 mx-auto z-30">
                    <input onChange={handleChange} type="text" placeholder="Search..." className="input input-bordered input-info w-full text-black text-xl " />
                    <button onClick={handleClick} className="h-12 w-12 md:w-28 btn-success absolute right-0 rounded-r-lg text-white px-4 font-medium">Search</button>
                </div>
            </div>
        </div>
    )
